...
const ListItem = ({ item, nodeRef, handleEditItem, handleDeleteItem }) => {
    ...
    return (
        <div
            ref={nodeRef}
            className={`grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-5 items-center p-5 text-white border-none rounded-xl shadow-[0px_4px_14px_3px_rgba(63,136,197,0.35)] ${
